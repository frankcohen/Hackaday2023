...
static SPIClass * videospi = new SPIClass();
static Arduino_DataBus *bus = new Arduino_HWSPI(Display_SPI_DC, Display_SPI_CS, Display_SPI_SCK, Display_SPI_MOSI, Display_SPI_MISO, videospi, false);
static Arduino_GFX *gfx = new Arduino_GC9A01(bus, Display_SPI_RST, 3 /* rotation */, false /* IPS */);
