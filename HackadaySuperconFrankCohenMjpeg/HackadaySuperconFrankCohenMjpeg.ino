...
void setup() {
  ...
  storage.begin();  // Includes starting the NAND device on SPI
  player.begin();
  ...
  */
  ...
  video.startVideo( "/36237a4763ae01c18202615ed6a6bc69/36237a4763ae01c18202615ed6a6bc69.mjpeg" );
